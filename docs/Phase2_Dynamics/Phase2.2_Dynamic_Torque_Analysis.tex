...
\midrule
มอเตอร์ A (ซ้าย) & \textit{TBD} & \textit{TBD} \\
มอเตอร์ B (ขวา) & \textit{TBD} & \textit{TBD} \\
\bottomrule
\end{tabular}
\caption{ความต้องการทอร์กไดนามิกสูงสุด (กรอกจากผลการจำลอง)}
\end{table}
...
\midrule
มอเตอร์ A & \textit{TBD} & \textit{TBD} & \textit{TBD}× \\
มอเตอร์ B & \textit{TBD} & \textit{TBD} & \textit{TBD}× \\
\bottomrule
\end{tabular}
